...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-layers"></i><span>Inventory</span></a>
                <ul class="ml-menu">
                    <li><a href="#">Add Inventory</a></li>
                    <li><a href="table_product.php">Manage Inventory</a></li>               
                 </ul>
...
<section class="content">
	...
	<div class="container-fluid">
			...
			<div class="row">
              &nbsp &nbsp &nbsp &nbsp &nbsp </br></br> <a href="#addnew" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add New Supplier</a>
			</div>
			<div class="height10">
			</div>
			<div class="body">
					...
					<thead>
						<tr>
						<th>&nbsp &nbsp &nbsp ID</th>
                        <th>&nbsp&nbsp &nbsp &nbsp &nbsp Supplier Name</th>
						<th>&nbsp &nbsp &nbsp &nbsp &nbsp Supplier Address</th>
						<th>&nbsp &nbsp &nbsp &nbsp &nbsp Contact Number</th>
						<th>&nbsp &nbsp &nbsp &nbsp &nbsp Action</th>
					</tr>
					</thead>
					<tbody>
						<?php
							...
							while($row = $query->fetch_assoc()){
								...
								"<tr>
									...
									<td>
									  &nbsp &nbsp &nbsp  <a href='#edit_".$row['supplier_id']."' class='btn btn-success btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span>Edit</a>
										<a href='#delete_".$row['supplier_id']."' class='btn btn-danger btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-trash'></span> Delete</a>
									</td>
								</tr>";
								include('supplier_edit_delete_modal.php');
							}
