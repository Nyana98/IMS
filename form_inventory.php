  ...
  <body>
    <div class="testbox">
      <form action="insert.php" method="POST">
        ...
        <br>
        <h6>LOAN APPLICATION (INVENTORY)</h6>
      ...
      <div class="body">
        <form class="form-group">
          <div class="row clearfix">
            ...
            <a href="orderinventory_add.php" class="btn btn-primary"><span class="glyphicon glyphicon-plus">Add New </a></br>
            <div class="body">
              <br>
              ...
              <tbody>
               ...
               <?php                  
                $query = 'SELECT * FROM inventory_request';
                    $result = mysqli_query($db, $query) or die (mysqli_error($db));
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<td> <a class="btn btn-xs btn-danger" href="orderinventory_del.php?type=asset&delete&id=' . $row['reqin_id'] . '"> Delete </a> ';
                            echo '</tr> ';
                             }
               ?> 
              </tbody>
