...
<section class="content">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Inventory Lists</li>
                    </ul>
    ...
    <div class="container-fluid">
            ...
            <div class="row">
              &nbsp &nbsp &nbsp &nbsp &nbsp <a href="#addnew" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add New Product</a>
            </div>
            <div class="height10">
            </div>
            <div class="body">
                        ...
                        <?php
                            ...
                            while($row = $query->fetch_assoc()){
                                ...
                                "<tr>
                                    ...
                                    <td><img src='upload/".$row['product_image']."' alt='Product Image' width='100' height='100'></td>
                                    ...
                                    <td>
                                    <a href='#edit_".$row['product_id']."' class='btn btn-success btn-sm' data-toggle='modal'><span >Edit</span></a>
                                    <td>
                                    <a href='#delete_".$row['product_id']."' class='btn btn-danger btn-sm' data-toggle='modal'><span >Delete</span> </a>
                                    </td>
                                </tr>";
                                
                                include('product_edit_delete_modal.php');
