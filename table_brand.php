...
<section class="content">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Brand Lists</li>
                    </ul>
	...
	<div class="container-fluid">
			...
			<div class="row">
              &nbsp &nbsp &nbsp &nbsp &nbsp </br></br> <a href="#addnew" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add New Brand</a>
			</div>
			<div class="height10">
			</div>
			<div class="body">
					...
					<thead>
                        ...
                        <th>&nbsp&nbsp &nbsp &nbsp &nbsp Brand Code</th>
						<th>&nbsp &nbsp &nbsp &nbsp &nbsp Brand Name</th>
						<th>&nbsp &nbsp &nbsp &nbsp &nbsp Brand Status</th>
						...
						<?php
							...
							while($row = $query->fetch_assoc()){
								...
								"<tr>
									...
									<td>
									  &nbsp &nbsp &nbsp  <a href='#edit_".$row['brand_id']."' class='btn btn-success btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span>Edit</a>
								...
								include('brand_edit_delete_modal.php');
							}
...
<?php include('brand_add_modal.php') ?>
